// components/ui/FiltersIngresos.tsx
import React, { useState } from 'react';

type FiltersIngresosProps = {
  onFilterChange: (filters: { fecha: string; concepto: string }) => void;
};

const FiltersIngresos: React.FC<FiltersIngresosProps> = ({ onFilterChange }) => {
...
export default FiltersIngresos;