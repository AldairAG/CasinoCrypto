...
import quinielaReducer from './slices/quinielasSlice'; // Importa el slice con datos de quiniela
...
const persistConfig = {
  ...
  whitelist: ['deportes', 'auth','quiniela','carrito'], // Solo persistir los slices 'deportes' y 'auth' (opcional)
};
